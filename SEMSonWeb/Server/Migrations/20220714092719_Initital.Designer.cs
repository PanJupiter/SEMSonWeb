...
namespace SEMSonWeb.Server.Migrations
{
    ...
    [Migration("20220714092719_Initital")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientProfile", b =>
                {
                    ...
                    b.Property<string>("SPClientUserPHUserCode")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("PHClassCode", "PHDepCode", "PHPosCode", "PHPreCode");

                    b.HasIndex("PHDepCode");

                    b.HasIndex("PHPosCode");

                    b.HasIndex("PHPreCode");

                    b.HasIndex("SPClientUserPHUserCode");
            ...
            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientUser", b =>
                {
                    ...
                    b.Property<string>("LSPClientProfilePHClassCode")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("LSPClientProfilePHDepCode")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("LSPClientProfilePHPosCode")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("LSPClientProfilePHPreCode")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("LSPClientProfilePHClassCode", "LSPClientProfilePHDepCode", "LSPClientProfilePHPosCode", "LSPClientProfilePHPreCode");
            ...
            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientProfile", b =>
                {
                    b.HasOne("SEMSonWeb.Shared.Entities.SPClientClass", "LSPClientClass")
                        .WithMany("SPClientProfileCla")
                        .HasForeignKey("PHClassCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SEMSonWeb.Shared.Entities.SPClientDep", "LSPClientDep")
                        .WithMany("SPClientProfileDep")
                        .HasForeignKey("PHDepCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SEMSonWeb.Shared.Entities.SPClientPos", "LSPClientPos")
                        .WithMany("SPClientProfilePos")
                        .HasForeignKey("PHPosCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SEMSonWeb.Shared.Entities.SPClientPre", "LSPClientPre")
                        .WithMany("SPClientProfilePre")
                        .HasForeignKey("PHPreCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SEMSonWeb.Shared.Entities.SPClientUser", null)
                        .WithMany("SPClientProfileUse")
                        .HasForeignKey("SPClientUserPHUserCode");
            ...
            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientUser", b =>
                {
                    b.HasOne("SEMSonWeb.Shared.Entities.SPClientProfile", "LSPClientProfile")
                        .WithMany()
                        .HasForeignKey("LSPClientProfilePHClassCode", "LSPClientProfilePHDepCode", "LSPClientProfilePHPosCode", "LSPClientProfilePHPreCode");
            ...
            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientClass", b =>
                {
                    b.Navigation("SPClientProfileCla");
                });

            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientDep", b =>
                {
                    b.Navigation("SPClientProfileDep");
                });

            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientPos", b =>
                {
                    b.Navigation("SPClientProfilePos");
                });

            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientPre", b =>
                {
                    b.Navigation("SPClientProfilePre");
                });

            modelBuilder.Entity("SEMSonWeb.Shared.Entities.SPClientUser", b =>
                {
                    b.Navigation("SPClientProfileUse");
                });
